...
public class AuthUtils {
	...
	public static Map<String, String> generateInterswitchAuth(String httpMethod, String resourceUrl,
		...
		System.out.println("signature cipher {} " + signatureCipher);
	...
	//	interswitchAuth.put(Constants.TERMINAL_ID, Constants.MY_TERMINAL_ID);
		...
		authToken = !terminalKey.isEmpty()?CryptoUtils.encrypt(authToken,terminalKey):"";
